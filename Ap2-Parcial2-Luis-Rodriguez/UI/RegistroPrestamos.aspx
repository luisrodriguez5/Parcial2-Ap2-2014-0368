        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group row">
                    <label for="PrestamoId" class="col-2 col-form-label">Id:</label>
                ...
                <div class="form-group row">
                    ...
                    <asp:TextBox ID="DireccionTextBox" runat="server" Class="form-control col-6"></asp:TextBox>
                </div>

                <div class="form-group row">
                    <label for="Monto" class="col-2">Monto:</label>
